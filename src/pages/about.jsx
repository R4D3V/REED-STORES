...
<div className="w-full max-w-sm overflow-hidden  rounded-lg shadow-lg ">
    ...
    <div className="container px-6 py-12 mx-auto">
        <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold  md:text-3xl dark:">Chat to our friendly team</h1>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    ...
                    <p className="mt-2 text-sm  dark:text-blue-400">hello@merakiui.com</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm  ">Our friendly team is here to help.</p>
                    <p className="mt-2 text-sm  dark:text-blue-400">Start new chat</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm  dark:text-blue-400">100 Smith Street Collingwood VIC 3066 AU</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm  dark:text-blue-400">+1 (555) 000-0000</p>
                </div>
            </div>
                ...
                <form>
                    <div className="-mx-2 md:items-center md:flex">
                        <div className="flex-1 px-2">
                            ...
                            <input type="text" placeholder="John " className="block w-full px-5 py-2.5 mt-2  placeholder-gray-400  border border-gray-200 rounded-lg dark:placeholder-gray-600 dark: dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>

                        <div className="flex-1 px-2 mt-4 md:mt-0">
                            <label className="block mb-2 text-sm text-gray-600 ">Last Name</label>
                            <input type="text" placeholder="Doe" className="block w-full px-5 py-2.5 mt-2  placeholder-gray-400  border border-gray-200 rounded-lg dark:placeholder-gray-600 dark: dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
                    </div>

                    <div className="mt-4">
                        <label className="block mb-2 text-sm text-gray-600 ">Email address</label>
                        <input type="email" placeholder="johndoe@example.com" className="block w-full px-5 py-2.5 mt-2  placeholder-gray-400  border border-gray-200 rounded-lg dark:placeholder-gray-600 dark: dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>

                    <div className="w-full mt-4">
                        <label className="block mb-2 text-sm text-gray-600 ">Message</label>
                        <textarea className="block w-full h-32 px-5 py-2.5 mt-2  placeholder-gray-400  border border-gray-200 rounded-lg md:h-56 dark:placeholder-gray-600 dark: dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
                    </div>
